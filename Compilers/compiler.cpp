...
//ADDED
#define ERROR_ELSE 				20
#define ERROR_REP				21
#define ERROR_UNTIL				22
#define ERROR_WRITE				23
#define ERROR_WRITELN			24
#define ERROR_TO				25
#define ERROR_DOWNTO			26
#define ERROR_OF				27
#define ERROR_CEND				28
#define ERROR_COLON				29
// -------------------------------------------
...
void error(int num)
{
	...
	switch (num)
	{
		...
		case ERROR_REL :
			...
			break;
		case ERROR_ELSE:
			cout << "ELSE symbol Expected";
			break;
		case ERROR_REP:
			cout << "REPEAT symbol Expected";
			break;
		case ERROR_UNTIL:
			cout << "UNTIL symbol Expected";
			break;
		case ERROR_WRITE:
			cout << "WRITE symbol Expected";
			break;
		case ERROR_WRITELN:
			cout << "WRITELN symbol Expected";
			break;
		case ERROR_TO:
			cout << "TO symbol Expected";
			break;
		case ERROR_DOWNTO:
			cout << "DOWNTO symbol Expected";
			break;
		case ERROR_OF:
			cout << "OF symbol Expected";
			break;
		case ERROR_CEND:
			cout << "CEND symbol Expected";
			break;
		case ERROR_COLON:
			cout << "COLON symbol Expected";
			break;
	}
	cout << endl;
	exit(1);
...
{
	//While loop to restrict globals
	do{
		if (sym == CONSTSYM)
		{
			// ---- CONSTANT SYM ----
